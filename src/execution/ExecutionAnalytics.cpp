...
void ExecutionAnalytics::writeCsv(const std::string& path, const ExecutionReport& report) {
        ...
        {"metric", "value"},
        {
            ...
            {"implementation_shortfall_usd", fi::core::formatDouble(report.implementationShortfall, 2)},
            {"execution_cost_vs_vwap_usd", fi::core::formatDouble(report.executionCost, 2)},
