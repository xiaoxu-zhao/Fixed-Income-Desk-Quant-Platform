...
int main(int argc, char** argv) {
    try {
        ...
        for (const auto& event : events) {
            ...
            {"timestamp_ns", "mid_price", "implied_yield_move_bp", "intraday_pnl_usd",
             "bid_price", "ask_price", "spread_price", "bid_depth_contracts", "ask_depth_contracts",
             "trade_size_contracts", "cumulative_trade_size_contracts"},
            rows);
